...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `${baseUrl}/api/og?title=Floridaog-fl-website.jpgsubtitle=Korean+Web+Design`, width: 1200, height: 630, alt: locale === 'ko' ? '플로리다 웹사이트 제작' : 'Florida Website Design' }],
    },
    alternates: {
