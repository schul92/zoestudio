          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <p className="text-gray-600">{locale === 'ko' ? '"해켄색 [업종]" 구글 검색 노출. 구글 비즈니스 프로필 최적화, 버겐카운티 로컬 키워드.' : 'Get found for "Hackensack [your business]" on Google. Google Business Profile optimization, Bergen County local keyword targeting.'}</p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { en: 'Tenafly', ko: '테나플라이', zip: '07670', highlight: false },
              ].map((area) => (
