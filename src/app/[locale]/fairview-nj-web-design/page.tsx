  ...
  if (locale === 'ko') {
    return {
      ...
      alternates: {
        ...
        languages: { 'x-default': `${baseUrl}/fairview-nj-web-design`, 'en': `${baseUrl}/fairview-nj-web-design`, 'ko': `${baseUrl}/ko/fairview-nj-web-design` },
      },
  ...
  const faqSchema = {
    ...
    mainEntity: locale === 'ko' ? [
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '네, 페어뷰와 클리프사이드파크 한인 비즈니스를 위한 이중언어(한영) 웹사이트, 한국어 SEO, 로컬 마케팅 등 맞춤 서비스를 제공합니다.' },
      },
      {
        '@type': 'Question',
        name: '페어뷰 근처에서 직접 만날 수 있나요?',
        acceptedAnswer: { '@type': 'Answer', text: '네, 버겐카운티 전역 출장 미팅이 가능합니다. 페어뷰, 포트리, 팰리세이즈파크 등 편한 장소에서 만나실 수 있습니다.' },
      },
    ] : [
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'Yes, we specialize in Korean-American businesses in Fairview and surrounding Bergen County towns. Bilingual websites, Korean SEO, and local marketing included.' },
      },
      {
        '@type': 'Question',
        name: 'Can we meet near Fairview?',
        acceptedAnswer: { '@type': 'Answer', text: 'Yes, we offer in-person meetings throughout Bergen County including Fairview, Fort Lee, and Palisades Park. Korean language consultations available.' },
      },
    ],
  }
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <p className="text-gray-600">
                  {locale === 'ko'
                    ? '"페어뷰 [업종]" 구글 검색 최적화. 구글 비즈니스 프로필, 로컬 키워드 타겟팅으로 지역 고객 확보.'
                    : 'Rank for "Fairview [your business]" on Google. Google Business Profile optimization and local keyword targeting to capture nearby customers.'}
                </p>
              </div>
        ...
        <section className="py-20 px-4 bg-emerald-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              {locale === 'ko' ? '페어뷰 비즈니스를 온라인에서 성장시키세요' : 'Grow Your Fairview Business Online'}
            </h2>
