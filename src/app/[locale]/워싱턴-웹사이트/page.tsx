    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: isKorean
            ? 'ZOE LUMOS의 워싱턴주 웹사이트 제작 비용은 기본 웹사이트 $500-$800, 일반 비즈니스 웹사이트 $1,100-$1,500, Shopify 이커머스 쇼핑몰 $1,800-$2,400입니다. 시애틀, 페더럴웨이, 타코마 등 워싱턴주 전 지역 동일 가격입니다. 화상 미팅으로 무료 상담이 가능합니다.'
            : 'ZOE LUMOS website design in Washington: basic websites $500-$800, standard business websites $1,100-$1,500, Shopify e-commerce stores $1,800-$2,400. Same pricing across Seattle, Federal Way, and Tacoma. Free consultation via video call.',
        },
      },
      {
        '@type': 'Question',
