...
const content = {
  en: {
    ...
    founder: {
      ...
      skills: ['Web Performance', 'SEO & Analytics', 'Google Ads', 'Shopify', 'Core Web Vitals', 'Bilingual Sites'],
  ...
  ko: {
    ...
    founder: {
      ...
      bio1: '저는 ZOE LUMOS를 시작하게 된 이유가 있습니다. 좋은 제품과 서비스를 가진 소규모 비즈니스들이 온라인에서 보이지 않는 것을 너무 많이 봤기 때문입니다. 저는 웹 성능과 SEO 전문가로, 각 프로젝트에 가장 적합한 기술을 선택합니다. 속도, 검색 순위, 전환율을 최우선으로 생각합니다. 고객이 밤 11시에 스마트폰으로 검색할 때 당신의 사이트가 먼저 보여야 하기 때문입니다.',
      ...
      skills: ['웹 성능 최적화', 'SEO & 분석', '구글 광고', 'Shopify', '코어 웹 바이탈', '이중언어 사이트'],
