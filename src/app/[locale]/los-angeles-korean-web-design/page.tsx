...
const cityData = koreanCities.find(c => c.slug === 'los-angeles-korean-web-design')!
...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  ...
  const enUrl = `${baseUrl}/los-angeles-korean-web-design`
  const koUrl = `${baseUrl}/ko/엘에이-웹사이트-제작`
