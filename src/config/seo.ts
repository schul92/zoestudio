  ...
  faqPage: {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We serve Korean-American businesses throughout NJ (Fort Lee, Palisades Park, Englewood, North Bergen, Edison, Ridgewood, Cliffside Park, Hackensack, Leonia, Tenafly, Edgewater) and NY (Manhattan, Flushing, Bayside, Brooklyn). We offer both in-person consultations and remote services."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! ZOE LUMOS offers full social media management for Korean-American businesses, including Instagram, Facebook, and X (Twitter). We create bilingual content in Korean and English, manage posting schedules, and run paid social ads to grow your following and drive customers to your door."
        }
      },
      {
        "@type": "Question",
        "name": "Can you optimize my Google My Business listing for Korean searches?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Absolutely. Google My Business (Google Business Profile) optimization is one of the most powerful local SEO tools for Korean-American businesses. ZOE LUMOS sets up and optimizes your profile with bilingual descriptions, photos, posts, and Q&As to help you rank at the top of local map searches in Fort Lee, Palisades Park, and the broader Bergen County area."
        }
      }
    ]
  },
