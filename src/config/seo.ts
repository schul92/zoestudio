export const seoConfig = {
  ...
  ko: {
    ...
    description: '뉴저지 웹사이트 제작 1위 업체 ★ 뉴욕 웹사이트 제작 전문. $999부터 — 포트리, 팰팍, 에디슨 한인 비즈니스 맞춤 웹사이트. 구글 광고, SEO, 쇼피파이 전문. 100% 한국어 상담. 무료 견적.',
