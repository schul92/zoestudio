export const seoConfig = {
  en: {
    title: 'ZOE LUMOS - NJ Web Design & SEO Agency | Small Business Website Development Fort Lee',
    description: 'Award-winning web design & SEO agency in Fort Lee, NJ. We build high-converting websites for small businesses across Bergen County & NYC metro. Google Ads, local SEO, Shopify. Bilingual Korean & English. ★ Free consultation — call today.',
    keywords: 'Fort Lee web design, Fort Lee NJ web designer, Bergen County web design, Korean business marketing NYC, NJ Korean SEO, Korean American digital marketing, Fort Lee website development, Palisades Park web design, small business SEO New Jersey, Korean web agency NJ, SEO services, Google Ads management, Shopify development, e-commerce website design, local SEO expert, website design and development, digital marketing agency, SEO consultant, web design services, small business SEO, ecommerce SEO, Englewood NJ SEO, North Bergen web design, small business SEO agency NJ, low cost SEO New Jersey, NJ web designer, web design Bergen County, website design Bergen County NJ, affordable web design NJ',
    openGraph: {
      title: 'ZOE LUMOS — NJ Web Design & SEO for Small Businesses | Fort Lee',
      description: 'Fort Lee NJ web design & SEO agency specializing in small businesses. Bergen County, Englewood, North Bergen & NYC metro. ★ Free consultation.',
      siteName: 'ZOE LUMOS',
      locale: 'en_US',
    }
  },
  ko: {
    ...
    description: '뉴저지 웹사이트 제작 1위 업체 ★ 포트리, 팰팍, 에디슨, 플러싱 한인 비즈니스 전문. 뉴욕 웹사이트 제작, NJ 홈페이지 제작, 구글 광고, 옐프 광고, SEO 최적화. 100% 한국어 상담 가능. 지금 무료 상담받으세요!',
...
export const structuredData = {
  ...
  localBusiness: {
    ...
    "slogan": "Your Korean-American Digital Marketing Partner in NJ & NYC",
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Custom website design and development for small businesses in NJ and NYC"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Local SEO optimization for Bergen County, Fort Lee, Englewood, and NYC metro area"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Google Ads PPC campaign management for Korean-American businesses"
          }
        }
      ]
    }
