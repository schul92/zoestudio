export const seoConfig = {
  ...
  ko: {
    ...
    description: '미국 한인 웹사이트 제작 1위. 뉴저지·뉴욕·캘리포니아·텍사스 등 전 지역 100개+ 사이트 제작 실적. 홈페이지·쇼핑몰·구글광고·SEO 전문. $499부터. 100% 한국어 무료 상담.',
