export const seoConfig = {
  en: {
    title: 'NJ Web Design & SEO Agency in Fort Lee | ZOE LUMOS',
    description: 'Web design & SEO agency in Fort Lee, NJ for small businesses. Serving Bergen County and NYC metro with Google Ads, local SEO, and Shopify support. Bilingual Korean/English. Free consultation.',
  ...
  ko: {
    ...
    description: '포트리, 팰팍, 에디슨, 플러싱 한인 비즈니스를 위한 뉴저지 웹사이트 제작 전문. 뉴욕 웹사이트 제작, NJ 홈페이지 제작, 구글 광고, 옐프 광고, SEO 최적화. 100% 한국어 상담 가능.',
