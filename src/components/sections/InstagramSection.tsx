...
const INSTAGRAM_REELS = [
  {
    id: 'DNwqeiqYk8s',
    url: 'https://www.instagram.com/reel/DNwqeiqYk8s/',
  },
  {
    id: 'DOUkdz9Ee9j',
    url: 'https://www.instagram.com/reel/DOUkdz9Ee9j/',
  },
]

const INSTAGRAM_PROFILE = 'https://www.instagram.com/zoelumos/'
const INSTAGRAM_HANDLE = '@zoelumos'

export default function InstagramSection({ locale = 'en' }: { locale?: string }) {
  ...
  const content = {
    en: {
      ...
      description: 'Check out our latest tips, tutorials, and behind-the-scenes content on website design and digital marketing.',
      followButton: 'Follow @zoelumos',
      viewOnInstagram: 'View on Instagram',
    },
    ko: {
      subtitle: '팔로우하기',
      title: '인스타그램 최신 소식',
      description: '웹사이트 디자인과 디지털 마케팅에 관한 최신 팁, 튜토리얼, 비하인드 콘텐츠를 확인하세요.',
      followButton: '@zoelumos 팔로우',
      viewOnInstagram: '인스타그램에서 보기',
    },
  }

  const text = content[locale as 'en' | 'ko'] || content.en

  // Process Instagram embeds when script loads
  useEffect(() => {
    if (embedsLoaded && typeof window !== 'undefined' && (window as any).instgrm) {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <motion.a
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
            >
          ...
          >
            {INSTAGRAM_REELS.map((reel, index) => (
              <motion.div
                ...
                className="w-full max-w-[540px] min-w-[326px]"
              >
                <blockquote
                ...
                >
                  <div style={{ padding: '16px' }}>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      {/* Instagram embed placeholder structure */}
          ...
          >
            ...
            >
              <span>{locale === 'ko' ? '더 많은 콘텐츠 보기' : 'See more content'}</span>
