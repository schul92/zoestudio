...
export const blogContent: BlogPost[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    readTime: 10,
    category: { en: 'SEO', ko: 'SEO' },
    title: { en: 'Local SEO 101: The Complete Guide for Korean-American Small Businesses (2026)', ko: '로컬 SEO 101: 한인 소상공업 완벽 가이드 (2026년)' },
    metaDescription: { en: 'Everything a Korean-American small business needs to know about local SEO in 2026. Google Business Profile, citations, reviews, and ranking factors explained.', ko: '2026년 한인 소상공업이 알아야 할 로컬 SEO의 모든 것. 구글 비즈니스 프로필, 인용, 리뷰, 랭킹 요소 총정리.' },
    author: 'ZOE LUMOS Team',
    sections: {
      en: [
