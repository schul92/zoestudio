...
export const blogContent: BlogPost[] = [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    category: { en: 'Marketing', ko: '마케팅' },
    title: {
      en: 'Yelp Ads vs Google Ads for Korean Restaurants: Where Your $500 Actually Works',
      ko: '옐프광고 vs 구글광고 — 한인 식당의 $500이 진짜 일하는 곳은 어디인가',
    },
    metaDescription: {
      en: 'Korean restaurants in NJ/NY are getting cold-called by Yelp every week. Should you say yes? Real conversion data from 12 Korean restaurant accounts on which platform turns ad spend into reservations.',
