...
export const blogContent: BlogPost[] = [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: {
      en: 'TJ Flowers (Manhattan, NY) had a slow Shopify store with low-quality photos and almost zero online sales. New site launched the second week of April 2026; first order arrived April 10. By May 6 — under four weeks later — gross sales +47%, total sales +59%, returning customer rate +40%, and AI search engines like ChatGPT now driving real revenue. The honest numbers, what we changed, and what it means for any Korean-American small business in 2026.',
      ko: '맨해튼의 TJ Flowers는 느린 Shopify와 낮은 품질의 사진 때문에 온라인 매출이 거의 없었다. 2026년 4월 둘째 주에 새 사이트를 런칭했고, 첫 주문은 4월 10일에 들어왔다. 5월 6일까지 — 4주도 채 안 되어 — 총매출 +47%, 전체 판매 +59%, 재구매율 +40%, 그리고 ChatGPT 같은 AI 검색이 실제 매출을 만들기 시작했다. 정직한 숫자, 우리가 바꾼 것, 그리고 2026년 한인 스몰비즈니스에게 이것이 의미하는 바.',
    },
    author: 'Zoe Lumos Studio',
    sections: {
      en: [
        ...
        { type: 'ul', content: 'Pulled directly from Shopify Analytics. Comparison window: Dec 24, 2025 – Feb 28, 2026 (pre-revamp baseline) vs. Mar 1 – May 6, 2026 — but essentially all of the new revenue lands after the April 10 launch, so the lift you see below is roughly four weeks of work, not two months.', items: [
          ...
          'Top product: Thistle Elegance — $544 in under four weeks from a single arrangement',
          'First order on the new site: April 10, 2026 — the moment the site stopped being a liability and started being a sales channel',
        ] },
      ...
      ko: [
        ...
        { type: 'ul', content: 'Shopify 애널리틱스에서 직접 가져온 데이터. 비교 기간은 2025년 12월 24일 – 2026년 2월 28일 (리뉴얼 전 베이스라인) vs. 2026년 3월 1일 – 5월 6일이지만 — 새 매출의 거의 전부가 4월 10일 런칭 이후에 발생했으므로, 아래 상승률은 사실상 두 달이 아닌 약 4주의 결과다.', items: [
          ...
          '톱 상품: Thistle Elegance — 단일 상품으로 4주 만에 $544',
          '새 사이트 첫 주문: 2026년 4월 10일 — 사이트가 "짐"에서 "매출 채널"로 바뀐 순간',
        ] },
