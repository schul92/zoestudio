  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    sections: {
      en: [
        ...
        { type: 'p', content: 'We are publishing the messy parts too. Migration from OpenCart imported 250 historical orders ($34,286) on March 6 — those are NOT new revenue and we excluded them. Five internal test orders ($2,230) — also excluded. What is below is real, Shopify-native, post-launch revenue only.' },
      ...
      ko: [
        ...
        { type: 'p', content: '지저분한 부분도 함께 공개한다. OpenCart에서 마이그레이션된 250건의 과거 주문 ($34,286)이 3월 6일에 들어왔는데 — 이건 새 매출이 아니므로 제외했다. 내부 테스트 주문 5건 ($2,230) — 역시 제외. 아래는 진짜, Shopify 네이티브 런칭 후 매출만이다.' },
