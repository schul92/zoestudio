...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-wholesale-rfq-quote-leads-seattle-korean-business-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-08 — B2B RFQ lead-generation angle (Seattle–Kent, WA)
  'b2b-wholesale-rfq-quote-leads-seattle-korean-business-2026': 'website-cost',
}
