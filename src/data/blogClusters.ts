...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-rfq-quote-lead-form-korean-trading-virginia-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-07-29 — B2B RFQ / quote lead capture (Annandale–Centreville–Manassas, VA)
  'b2b-rfq-quote-lead-form-korean-trading-virginia-2026': 'website-cost',
}
