...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-wholesale-quote-leads-website-georgia-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-07-31 — B2B wholesale/trading quote-lead generation (Norcross/Doraville, GA)
  'b2b-wholesale-quote-leads-website-georgia-2026': 'website-cost',
}
