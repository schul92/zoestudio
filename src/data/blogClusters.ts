...
export const PILLARS = {
  ...
  'professional-services': {
    ...
    posts: [
      ...
      'korean-real-estate-agent-showing-noshow-las-vegas-2026',
    ],
  },
  'ai-services': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-28 — Real estate agent showing scheduling, no-show prevention, Google Maps (Las Vegas, NV)
  'korean-real-estate-agent-showing-noshow-las-vegas-2026': 'professional-services',
}
