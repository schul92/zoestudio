...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'wholesale-trading-rfq-quote-leads-los-angeles-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-05 — LA Korean-American wholesale/trading RFQ lead-capture guide
  'wholesale-trading-rfq-quote-leads-los-angeles-2026': 'website-cost',
}
