...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-wholesale-website-rfq-leads-seattle-korean-business-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-03 — B2B wholesale/trading RFQ lead generation (Seattle / Pacific Northwest)
  'b2b-wholesale-website-rfq-leads-seattle-korean-business-2026': 'website-cost',
}
