...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-trading-company-domain-email-credibility-austin-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-09-02 — B2B trust/credibility: domain email + real website as the first
  // filter buyers apply (Austin-Taylor, TX semiconductor supply-chain corridor)
  'b2b-trading-company-domain-email-credibility-austin-2026': 'website-cost',
}
