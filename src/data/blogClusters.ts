...
export const PILLARS = {
  ...
  'beauty-wellness': {
    ...
    posts: [
      ...
      'korean-nail-beauty-salon-booking-noshow-las-vegas-2026',
    ],
  },
  'website-cost': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-09-04 — nail/beauty salon booking + no-show prevention + Google Maps (Las Vegas)
  'korean-nail-beauty-salon-booking-noshow-las-vegas-2026': 'beauty-wellness',
}
