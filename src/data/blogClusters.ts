...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-auto-supplier-domain-email-trust-alabama-2026',
    ],
  },
  'kakaotalk-marketing': {
    ...
    posts: [
      ...
      'korean-business-social-media-marketing-nj-2026',
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  'korean-business-social-media-marketing-nj-2026': 'kakaotalk-marketing',
  ...
  // 2026-09-12 — B2B vendor-trust angle: domain-matched company email +
  // real website as fraud-risk screening, for Korean auto-parts suppliers
  // around Montgomery, Alabama's automotive corridor
  'b2b-auto-supplier-domain-email-trust-alabama-2026': 'website-cost',
}
