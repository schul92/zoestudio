...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-wholesale-website-rfp-leads-seattle-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-14 — B2B/wholesale RFP lead-generation (Seattle, WA)
  'b2b-wholesale-website-rfp-leads-seattle-2026': 'website-cost',
}
