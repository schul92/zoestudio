...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'la-korean-wholesale-trading-b2b-website-rfq-leads-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-12 — LA B2B wholesale/trading lead-generation (RFQ funnel, buyer-search SEO)
  'la-korean-wholesale-trading-b2b-website-rfq-leads-2026': 'website-cost',
}
