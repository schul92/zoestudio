...
export const PILLARS = {
  ...
  'beauty-wellness': {
    ...
    posts: [
      ...
      'korean-nail-beauty-salon-booking-noshow-san-diego-2026',
    ],
  },
  'website-cost': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-25 — nail/beauty studio booking + no-show prevention + Google Maps (San Diego Convoy District)
  'korean-nail-beauty-salon-booking-noshow-san-diego-2026': 'beauty-wellness',
}
