...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-trading-wholesale-email-domain-credibility-chicago-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-09-08 — B2B trading/wholesale: company-domain email + website credibility (Chicago)
  'b2b-trading-wholesale-email-domain-credibility-chicago-2026': 'website-cost',
}
