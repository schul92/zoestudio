...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-trading-wholesale-trust-website-chicago-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-09-09 — B2B trust/credibility: company-domain email vs. gmail/naver,
  // wire-fraud verification, trust-building website (Chicago wholesale/trading)
  'b2b-trading-wholesale-trust-website-chicago-2026': 'website-cost',
}
