...
export const PILLARS = {
  ...
  'beauty-wellness': {
    ...
    posts: [
      ...
      'korean-hair-salon-booking-noshow-las-vegas-2026',
    ],
  },
  'website-cost': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-09-05 — Hair salon multi-stylist booking + no-show deposits + Google Maps (Las Vegas, NV)
  'korean-hair-salon-booking-noshow-las-vegas-2026': 'beauty-wellness',
}
