...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'korean-trading-company-miami-export-trust-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-24 — B2B trade-transparency guide (MOQ/Incoterms/lead time) for Korean trading
  // companies in Miami-Dade, the US gateway to Latin America/Caribbean trade
  'korean-trading-company-miami-export-trust-2026': 'website-cost',
}
