...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'b2b-wholesale-trading-rfq-leads-seattle-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-08-04 — B2B/wholesale RFQ lead generation (Seattle–Tacoma, WA)
  'b2b-wholesale-trading-rfq-leads-seattle-2026': 'website-cost',
}
