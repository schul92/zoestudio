...
export const PILLARS = {
  ...
  'website-cost': {
    ...
    posts: [
      ...
      'korea-sourcing-customs-duties-ecommerce-los-angeles-2026',
    ],
  },
  'kakaotalk-marketing': {
...
export const POST_TO_PILLAR: Record<string, PillarKey> = {
  ...
  // 2026-07-30 — Korea sourcing → US resale: customs, duties, economic nexus (Los Angeles)
  'korea-sourcing-customs-duties-ecommerce-los-angeles-2026': 'website-cost',
}
